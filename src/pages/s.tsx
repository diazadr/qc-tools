...
const LandingPage = () => {
  ...
  return (
    <div className="w-full page">
      ...
      {/* HERO ================================================== */}
<section className="relative w-full min-h-screen flex flex-col md:flex-row overflow-hidden bg-[#0d1117]">

  {/* TEKS KIRI */}
  <div className="
    w-full md:w-[50%] flex flex-col justify-center
    px-6 md:pl-16 md:pr-10
    z-20
    pt-24 md:pt-0
  ">
    <h1 className="
      ...
      leading-[1.12]
      text-[2rem] sm:text-[2.4rem] md:text-[3.6rem]
      max-w-[90%] md:max-w-xl
    ">
      {t("landing.hero1")} <span className="word-underline">{t("landing.hero2")}</span>
      <br />
      {t("landing.hero3")}
    </h1>

    <p className="mt-5 max-w-[95%] md:max-w-md text-white/70 text-base sm:text-lg">
      {t("landing.subtitle")}
    </p>

    <motion.button
      whileHover={{ scale: 1.05 }}
      className="mt-7 bg-primary px-7 py-3 rounded-full text-white font-semibold text-base sm:text-lg shadow-md w-max"
    >
      {t("landing.use")}
    </motion.button>
  </div>
  ...
  {/* GAMBAR KANAN */}
  <div className="
    relative w-full md:w-[60%] h-[300px] sm:h-[380px] md:h-full
    diagonal-wrapper md:absolute md:right-0 md:top-0
  ">
    <div className="hero-img-diagonal" style={{ backgroundImage: "url('/img/factory1.jpg')" }} />
  </div>
